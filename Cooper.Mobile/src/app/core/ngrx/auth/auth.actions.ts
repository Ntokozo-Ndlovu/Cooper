import { Person, Contact, Address } from '../../models';
...
export const reqRegisterUser = createAction('[From Sign Up Page] Register a new user', props<{ userName:string, contact:Contact, address:Address, person:Person, password:string }>());

export const completePersonForm = createAction('[From SignUp Person Page] Person form complete', props<{ username: string, person: Person, password: string }>());
